...
type
  ETokenKind = (
    ...
    tkKW_AT,    tkKW_ARRAY,  tkKW_BEGIN,  tkKW_BREAK,  tkKW_CASE,  tkKW_CONTINUE,
    tkKW_DO,    tkKW_ELSE,   tkKW_ELIF,   tkKW_END,    tkKW_FOR,   tkKW_FUNC,
    tkKW_IF,    tkKW_NIL,    tkKW_OF,     tkKW_PASS,   tkKW_PRINT, tkKW_PROC,
    tkKW_RECORD,tkKW_REF,    tkKW_REPEAT, tkKW_RETURN, tkKW_THEN,  tkKW_TYPE,
    tkKW_VAR,   tkKW_WHILE,
...
const
  ...
  ReservedWords: array [0..36] of TReservedName = (
      ...
      (Value: 'procedure'; Token: tkKW_PROC),
  ...
  TokenString: array[ETokenKind] of string = (
    '', #10#13,
    //keywords
    'at',     'array',  'begin',  'break',  'case',   'continue',
    'do',     'else',   'elif',   'end',    'for',    'function',
    'if',     'nil',    'of',     'pass',   'print',  'procedure',
    'record', 'ref',    'repeat', 'return', 'then',   'type',
    'var',    'while',
